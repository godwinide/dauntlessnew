...
function(a, b) {
    ...
    function s(a, d, e, f, g, h) {
        ...
        var i, j, k, l, m, n, p = a.ms,
            ...
            t = {};
        if (f)
            for (v = 0, x = gb.length; x > v; v++) {
                var u = gb[v];
                if (u.el.id == d.id && u.anim == a) {
                    u.percent != e ? (gb.splice(v, 1), k = 1) : j = u, d.attr(u.totalOrigin);
                    break
                }
            } else f = +s;
        ...
        if (i) {
            if (j) j.initstatus = f, j.start = new Date - j.ms * f;
                ...
                if (n = i.start || a.start || +new Date, u = {
                        ...
                        origin: d.attr(),
                        totalOrigin: g
                    }, gb.push(u), f && !j && !k && (u.stop = !0, u.start = new Date - p * f, 1 == gb.length)) return ib();
                k && (u.start = new Date - u.ms * f), 1 == gb.length && hb(ib)
            }
    ...
    function t(a) {
        for (var b = 0; b < gb.length; b++) gb[b].el.paper == a && gb.splice(b--, 1)
    }
    ...
    var u, v, w = /[, ]+/,
        ...
        qa = c.mapPath = function(a, b) {
            if (!b) return a;
            var c, d, e, f, g, h, i;
            for (a = Ja(a), e = 0, g = a.length; g > e; e++)
    ...
    var ta = function(a) {
            if (c.vml) {
                ...
                i.title = "Raphaël Colour Picker", i.style.display = "none", A.doc.body.appendChild(i), ta = f(function(a) {
    ...
    c.color = function(a) {
        ...
        var e, f, g, h, i;
        return a = a % 360 / 60, i = 2 * b * (.5 > c ? c : 1 - c), h = i * (1 - Q(a % 2 - 1)), e = f = g = c - i / 2, a = ~~a, e += [i, h, 0, 0, h, i][a], f += [h, i, i, h, 0, 0][a], g += [0, 0, h, i, i, h][a], ya(e, f, g, d)
    ...
    c.getRGB = f(function(a) {
        ...
        var d = {
            ...
            e = [];
        return c.is(a, V) && c.is(a[0], V) && (e = Ba(a)), e.length || I(a).replace(ha, function(a, b, c) {
            var f = [],
                g = b.toLowerCase();
        ...
        if (!a) return null;
        var b = [];
        return c.is(a, V) && c.is(a[0], V) && (b = Ba(a)), b.length || I(a).replace(ia, function(a, c, d) {
            {
                var e = [];
                M.call(c)
            }
    ...
    for (var Pa = function() {
            ...
            return A.doc.addEventListener ? function(a, b, c, d) {
                    ...
                    var f = function(b) {
                        for (var e = Ta(b), f = b, g = 0, h = b.targetTouches && b.targetTouches.length; h > g; g++)
                            if (b.targetTouches[g].target == a) {
                                b = b.targetTouches[g], b.originalEvent = f, b.preventDefault = Qa, b.stopPropagation = Sa;
                                break
                            }
                ...
                var e = function(a) {
                    ...
                    var b = A.doc.documentElement.scrollTop || A.doc.body.scrollTop,
                        ...
                        f = a.clientX + e,
                        g = a.clientY + b;
                    return a.preventDefault = a.preventDefault || Pa, a.stopPropagation = a.stopPropagation || Ra, c.call(d, a, f, g)
                };
            ...
            for (var d, e = Va.length; e--;) d = Va[e], d.el._drag = {}, b("raphael.drag.end." + d.el.id, d.end_scope || d.start_scope || d.move_scope || d.el, a);
            Va = []
        }, Ya = c.el = {}, Za = K.length; Za--;) ! function(a) {
    ...
    Ya.drag = function(a, d, e, f, g, h) {
        function i(i) {
            ...
            this._drag.x = j + m, this._drag.y = k + l, !Va.length && c.mousemove(Wa).mouseup(Xa), Va.push({
                el: this,
                move_scope: f,
                start_scope: g,
                end_scope: h
        ...
        for (var a = $a.length; a--;) $a[a].el == this && (this.unmousedown($a[a].start), $a.splice(a, 1), b.unbind("raphael.drag.*." + this.id));
        !$a.length && c.unmousemove(Wa).unmouseup(Xa), Va = []
    ...
    var ab = function(a, b, d, e, f, g, h, i, l) {
            ...
            return function(d, e, f) {
                ...
                for (var g, h, i, j, k, l = "", m = {}, n = 0, o = 0, p = d.length; p > o; o++) {
                    if (i = d[o], "M" == i[0]) g = +i[1], h = +i[2];
                        ...
                        if (j = ab(g, h, i[1], i[2], i[3], i[4], i[5], i[6]), n + j > e) {
                            if (b && !m.start) {
                                if (k = ab(g, h, i[1], i[2], i[3], i[4], i[5], i[6], e - n), l += ["C" + k.start.x, k.start.y, k.m.x, k.m.y, k.x, k.y], f) return l;
                                m.start = l, l = ["M" + k.x, k.y + "C" + k.n.x, k.n.y, k.end.x, k.end.y, i[5], i[6]].join(), n += j, g = +i[5], h = +i[6];
                                continue
                            }
                            if (!a && !b) return k = ab(g, h, i[1], i[2], i[3], i[4], i[5], i[6], e - n), {
                                x: k.x,
                                y: k.y,
                                alpha: k.alpha
                            }
        ...
        db = bb(),
        eb = bb(0, 1);
    c.getTotalLength = cb, c.getPointAtLength = db, c.getSubpath = function(a, b, c) {
        if (this.getTotalLength(a) - c < 1e-6) return eb(a, b).end;
        var d = eb(a, c, 1);
        return b ? eb(d, b).end : d
    }, Ya.getTotalLength = function() {
        var a = this.getPath();
        if (a) return this.node.getTotalLength ? this.node.getTotalLength() : cb(a)
    ...
    fb.easeIn = fb["ease-in"] = fb["<"], fb.easeOut = fb["ease-out"] = fb[">"], fb.easeInOut = fb["ease-in-out"] = fb["<>"], fb["back-in"] = fb.backIn, fb["back-out"] = fb.backOut;
    var gb = [],
            ...
            for (var a = +new Date, d = 0; d < gb.length; d++) {
                ...
                if (!e.el.removed && !e.paused) {
                    var f, g, h = a - e.start,
                        ...
                        o = {},
                        p = {};
                    if (e.initstatus ? (h = (e.initstatus * e.anim.top - e.prev) / (e.percent - e.prev) * i, e.status = e.initstatus, delete e.initstatus, e.stop && gb.splice(d--, 1)) : e.status = (e.prev + (e.percent - e.prev) * (h / i)) / e.anim.top, !(0 > h))
                        if (i > h) {
                            var q = j(h / i);
                            for (var r in k)
                                if (k[z](r)) {
                            ...
                            if (function(a, d, e) {
                                ...
                                }(e.callback, n, e.anim), n.attr(m), gb.splice(d--, 1), e.repeat > 1 && !e.next) {
    ...
    Ya.animateWith = function(a, b, d, e, f, g) {
        ...
        for (c = gb.length; c > f; f++)
            if (d = gb[f], d.el.id == this.id && (!a || d.anim == a)) {
        ...
        for (var c = 0; c < gb.length; c++) gb[c].el.id != this.id || a && gb[c].anim != a || b("raphael.anim.pause." + this.id, this, gb[c].anim) !== !1 && (gb[c].paused = !0);
        return this
        ...
        for (var c = 0; c < gb.length; c++) gb[c].el.id != this.id || a && gb[c].anim != a || b("raphael.anim.stop." + this.id, this, gb[c].anim) !== !1 && gb.splice(c--, 1);
        return this
    }, b.on("raphael.remove", t), b.on("raphael.clear", t), Ya.toString = function() {
        return "Raphaël’s object"
    };
    var kb = function(a) {
            if (this.items = [], this.length = 0, this.type = "set", a)
                for (var b = 0, c = a.length; c > b; b++) !a[b] || a[b].constructor != Ya.constructor && a[b].constructor != kb || (this[this.items.length] = this.items[this.items.length] = a[b], this.length++)
        },
        lb = kb.prototype;
    lb.push = function() {
        for (var a, b, c = 0, d = arguments.length; d > c; c++) a = arguments[c], !a || a.constructor != Ya.constructor && a.constructor != kb || (b = this.items.length, this[b] = this.items[b] = a, this.length++);
        return this
    }, lb.pop = function() {
    ...
    for (var mb in Ya) Ya[z](mb) && (lb[mb] = function(a) {
        return function() {
            var b = arguments;
    ...
    return lb.attr = function(a, b) {
        ...
        }, c.st = lb, b.on("raphael.DOMload", function() {
            u = !0
        }),
        function(a, b, d) {
            function e() {
