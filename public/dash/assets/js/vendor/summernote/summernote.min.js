    ...
    var b, c = "function" == typeof define && define.amd,
        ...
        j = function() {
            var b = function(b) {
                ...
                oa = function(a, b) {
                    ...
                    var c = ka(b);
                    return a.style.cssText && (c.style.cssText = a.style.cssText), R(c, g.from(a.childNodes)), Q(c, a), ma(a), c
                },
                pa = l("TEXTAREA"),
                qa = function(a, b) {
        ...
        r = function() {
            ...
            this.insertTab = function(a, b, c) {
                ...
                if (e) {
                    if (j.isEmpty(e) && j.isLi(e)) return void b.toggleList(e.parentNode.nodeName);
                    d = j.splitTree(e, c.getStartPoint());
                    var f = j.listDescendant(e, j.isEmptyAnchor);
                    f = f.concat(j.listDescendant(d, j.isEmptyAnchor)), a.each(f, function(a, b) {
                        j.remove(b)
                    })
                } else {
                    var g = c.sc.childNodes[c.so];
                    d = a(j.emptyPara)[0], g ? c.sc.insertBefore(d, g) : c.sc.appendChild(d)
                }
        ...
        t = function(b) {
            ...
            for (var n = this.beforeCommand = function(a) {
                ...
                }, t = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor", "foreColor", "insertHorizontalRule", "fontName"], u = 0, v = t.length; v > u; u++) this[t[u]] = function(a) {
                return function(b, c) {
            ...
            this.tab = function(a, b) {
                var c = k.create();
                c.isCollapsed() && c.isOnCell() ? d.tab(c) : (n(a), f.insertTab(a, c, b.tabsize), o(a))
            }, this.untab = function() {
                var a = k.create();
                ...
                n(a), b = e.isMSIE ? "<" + b + ">" : b, document.execCommand("FormatBlock", !1, b), o(a)
            }, this.formatPara = function(a) {
                n(a), this.formatBlock(a, "P"), o(a)
            };
            for (var u = 1; 6 >= u; u++) this["formatH" + u] = function(a) {
                return function(b) {
            ...
            this.fontSize = function(b, d) {
                ...
                if (b.isOnAnchor()) {
                    ...
                    b = k.createFromNode(c), b.select(), n(a), document.execCommand("unlink"), o(a)
                }
                ...
                var c = JSON.parse(b),
                    d = c.foreColor,
                    e = c.backColor;
                n(a), d && document.execCommand("foreColor", !1, d), e && document.execCommand("backColor", !1, e), o(a)
            }, this.insertTable = function(a, b) {
                var c = b.split("x");
                n(a);
                var e = k.create();
                e = e.deleteContents(), e.insertNode(d.createTable(c[0], c[1])), o(a)
            }, this.floatMe = function(a, b, c) {
                n(a), c.css("float", b), o(a)
            }, this.imageShape = function(a, b, c) {
                n(a), c.removeClass("img-rounded img-circle img-thumbnail"), b && c.addClass(b), o(a)
                ...
                n(c), e.detach(), b.bindCustomEvent(a(), c.data("callbacks"), "media.delete").call(e, this.$editable), o(c)
            }, this.focus = function(a) {
                a.focus(), e.isFF && k.createFromNode(a[0].firstChild || a[0]).collapse().select()
            }
        },
        u = function() {
    ...
    var B = function(a) {
            this.sync = function(b) {
                ...
                var l = j.value(h, i.prettifyHtml) || j.emptyPara,
                    m = g.html() !== l;
                g.html(l), g.height(i.height ? h.height() : "auto"), d.removeClass("codeview"), m && a.bindCustomEvent(c, g.data("callbacks"), "change")(g.html(), g), g.focus(), a.invoke("toolbar.updateCodeview", f, !1)
            }
        },
        C = function(b) {
            var c = a(document);
        ...
        D = function(a) {
            ...
            var b = function(b) {
                ...
                i && a.insertImages(d, [h.getAsFile()]), a.invoke("editor.afterCommand", e)
            }
        },
        E = function(b) {
            var c = function(a, b) {
            ...
            var d = {
                ...
                p = function(c) {
                    ...
                    if (e.length) {
                        ...
                        if (l && e.parents(".popover").hide(), a.isFunction(a.summernote.pluginEvents[h])) a.summernote.pluginEvents[h](c, b.editor, m, k);
                        else if (b.editor[h]) {
                            var o = m.editable();
            ...
            this.bindKeyMap = function(c, e) {
                ...
                g.on("keydown", function(h) {
                    ...
                    if (k)
                        ...
                        } else b.editor[k] ? (b.editor[k](g, f.data("options")), h.preventDefault()) : d[k] && (d[k].call(this, c), h.preventDefault());
                    else n.isEdit(h.keyCode) && b.editor.afterCommand(g)
                })
            }, this.attach = function(a, c) {
                c.shortcuts && this.bindKeyMap(a, c.keyMap[e.isMac ? "mac" : "pc"]), a.editable().on("mousedown", h), a.editable().on("keyup mouseup", i), a.editable().on("scroll", k), b.clipboard.attach(a, c), b.handle.attach(a, c), a.popover().on("click", p), a.popover().on("mousedown", l), b.dragAndDrop.attach(a, c), c.airMode || (a.toolbar().on("click", p), a.toolbar().on("mousedown", l), b.statusbar.attach(a, c));
                ...
                a.editable().data("NoteHistory", m), a.editable().data("callbacks", {
                    onInit: c.onInit,
                    onFocus: c.onFocus,
                    onBlur: c.onBlur,
                ...
                var f = b.holder(),
                    h = b.editable(),
                    i = h.data("callbacks");
                h.focus(c(f, i, "focus")), h.blur(c(f, i, "blur")), h.keydown(function(a) {
                    a.keyCode === n.code.ENTER && c(f, i, "enter").call(this, a), c(f, i, "keydown").call(this, a)
                }), h.keyup(c(f, i, "keyup")), h.on("mousedown", c(f, i, "mousedown")), h.on("mouseup", c(f, i, "mouseup")), h.on("scroll", c(f, i, "scroll")), h.on("paste", c(f, i, "paste"));
                var k = e.isMSIE ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input";
                h.on(k, function() {
                    c(f, i, "change")(h.html(), h)
                }), d.airMode || (b.toolbar().click(c(f, i, "toolbar.click")), b.popover().click(c(f, i, "popover.click"))), j.isTextarea(g.head(f)) && f.closest("form").submit(function(a) {
